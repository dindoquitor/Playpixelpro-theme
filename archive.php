...
<header style="margin-bottom: 32px;">
	<h1 style="font-size: 1.8rem; margin: 0 0 4px; color: var(--gold); text-transform: none;">
		<span style="color: var(--muted);"><?php echo esc_html( $prompt_prefix ); ?></span> ls /archive/<?php single_term_title(); ?>
		<?php if ( $enable_cursor ) : ?>
			<span class="cli-cursor"></span>
		<?php endif; ?>
	</h1>
	<div class="meta" style="font-size: 0.85rem; color: var(--muted);">
		Listing archive objects for <?php the_archive_title(); ?>... [OK]
	</div>
</header>
...
<div class="blog-layout-grid">
	<section class="blog-posts-column">
		...
		<?php else : ?>
			<p><?php esc_html_e( 'No archive objects found.', 'playpixelpro' ); ?></p>
		<?php endif; ?>
	</section>
